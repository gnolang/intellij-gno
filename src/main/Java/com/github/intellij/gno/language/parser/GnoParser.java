...
import static com.github.intellij.gno.language.psi.GnoTypes.*;
...
public class GnoParser implements PsiParser, LightPsiParser {
    ...
    public static boolean property(PsiBuilder b, int l) {
        ...
        exit_section_(b, l, m, r, false, GnoParser::recover_property);
        return r;
    }
    ...
    /* ********************************************************** */
    // item_*
    static boolean gnoFIle(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "gnoFile")) return false;
        while (true) {
